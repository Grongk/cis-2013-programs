...
var generate = function () 
{
	...
	intCount = $("total_fib").value;

if(isNaN(intCount)||intCount < 2|| intCount > 100) //checks to see if the input is a number between 2 and 100
{
	alert("Out of range :(");
	$("total_fib").value = ""; //reverts the total count to nothing
}
else
{
	while(intCount > 2) 
	{
		...
		intCount--; //continues the cycle 
	}
}
$("output").value = stringOutput; //send the js output back to the html 
}
